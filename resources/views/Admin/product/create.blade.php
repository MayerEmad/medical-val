                        ...
                        <!-- /.card-header -->                      
                            ...
                            <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data" files="true">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ar_name" class="form-control" id="product_ar_name_id" value="{{ old('ar_name') }}" placeholder="Arabic Name">
                                </div>
                                <div class="row">
                                    <div class="col-12 col-sm-4">
                                        <label>Quantity</label>
                                        <input type="text" name="quantity" class="form-control" id="product_quantity_id" value="{{ old('quantity') }}" placeholder="product quantity">
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <label>Price</label>
                                        <input type="text" name="price" class="form-control" id="product_price_id" value="{{ old('price') }}" placeholder="product price">
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <label>Discount</label>
                                        <input type="text" name="discount" class="form-control" id="product_discount_id" value="{{ old('discount') }}" placeholder="discount ratio">
                                    </div>
                                </div><br>
                                <div class="form-group">
                                    <label>Product Description</label>
                                    <textarea class="form-control" name="description" id="product_description_id"  rows="2">{{ old('description') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>Product Description in Arabic</label>
                                    <textarea class="form-control" name="ar_description" id="product_ar_description_id"  rows="2">{{ old('ar_description') }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="file" name="image" id="theFileInput" value="{{ old('image') }}" style="display:none;" accept="image/*">
                                ...
                                <input type="hidden" name="category_id"  id="product_category_id" value="{{ $category->id }}" >
                                <div class="form-group">
                                <button type="submit" class="btn btn-primary col-lg-4 ">Save New Product</button>
                                </div>
                            </form>
