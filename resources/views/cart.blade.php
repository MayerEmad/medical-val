        ...
        <div class="container-fluid cart-container border-top">
                            ...
                            <tr class="border-bottom">
                                <td class="row pb-3 pt-3" style="max-width: 100%;padding: 0;margin: 0;">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <a href="#" style="color: #6dae21">Add to Wishlist</a>
            ...
            <div class="col-lg-3 summary">
                    <div class="pl-3 order" style="border: 1px solid #cccccc;border-radius: 10px;overflow-y: scroll;height: 420px;">
                        ...
                        <hr style="width: 95%;">
                        <div class="">
                            <p style="color: #85c442;font-size: 14px;">Rewards Discount: <span class="text-danger" style="float: right;font-size: 16px;">-$24.44</span></p>
                            <p class="pt-0" style="font-size: 11px;line-height: 1px;">Applied to 2 items</p>
                        </div>
                        <hr>
                        <div class="">
                            <p>Items Total: <span style="float: right;font-size: 16px;">$69.55</span></p>
                            <p style="color: #85c442;font-weight: 500;">Discounts: <span class="text-danger" style="float: right;font-size: 16px;font-weight: 400;">-$24.44</span></p>
                        </div>
                        <hr>
                        <div class="">
                        ...
                        <div class="pr-3 mb-4">
                            <a href="/checkout" class="btn w-100 cart-btn" type="button">Proceed to Checkout</a>
                        </div>
                    </div>
